...
const DEMO_POSTCARDS: Postcard[] = [
  {
    ...
    name: "Sarah",
    message:
      "Congratulations Alaa & Dinah! Little Moussa is so lucky to have you both. Can't wait to meet the little one! 🥰",
    imageUrl:
  ...
  },
  {
    ...
    name: "Marcus",
    message:
      "Welcome to the world, Moussa! Wishing your family all the love and sleepless nights (the good kind!) 😄🍼",
    imageUrl:
  ...
  },
  {
    ...
    name: "Priya",
    message:
      "What wonderful news! Moussa is going to bring so much joy. Enjoy every moment — they grow up so fast! 💛",
    imageUrl:
  ...
  },
  {
    ...
    name: "James",
    message:
      "Huge congrats to the whole family! Moussa already has the best parents. Here's to new adventures! 🎉",
    imageUrl:
